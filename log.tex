...
The mathematical content of this note is a detailed sketch of the construction of this
...
we will look at two more concrete examples.
...
\marginnote{Write this up!}

Of course, we haven't defined what we mean by $\det\fsl D$, and indeed the goal of this note
is to understand $\det\fsl D$ mathematically. Let us first note the difficulties. The most
...
by the space $\mathcal{F}_b$ of bosonic states. Thus we are forced to work with families
...
\subsubsection{Geometric quantization of Chern-Simons theory}
